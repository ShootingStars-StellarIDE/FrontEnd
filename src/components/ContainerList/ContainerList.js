    ...
    <div className="contents">
      <div className="contents-header">
        ...
        <div className="searchbar-line">
          ...
          >
            <option id={"sortingType1"} value="DATE_ASC">
              날짜 오름차순
            </option>
            <option id={"sortingType2"} value="DATE_DESC">
              날짜 내림차순
            </option>
            <option id={"sortingType3"} value="TITLE_ASC">
              이름 오름차순
            </option>
            <option id={"sortingType4"} value="TITLE_DESC">
              이름 내림차순
            </option>
          </select>
        </div>
      ...
      <div className="container-cards">
        {/* 컨테이너 추가 */}
        <div onClick={handleFirstItemClick}>+</div>
        ...
        {cards.map((card) => (
          <div className="concards" key={card.id}>
            ...
            <div className="idestart" onClick={openModal}>
              시작하기
            </div>
